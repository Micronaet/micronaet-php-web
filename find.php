...
<head>
<title><?php echo $company; ?>: Ricerca esistenza</title>
...
<form name="frmCerca" method="get" action="status.php">
  <tr align="center" bgcolor="#003300">
    <td height="40" colspan="3"><span class="style1"><?php echo "$company"; ?>: RICERCA ESISTENZA PRODOTTI
  ...
  <tr bgcolor="#003366">
    ...
    <input type="hidden" name="company_next" value="<?php echo $company_next?>">
  </tr>
  <tr bgcolor="#003366">
